    ...
    <>
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center justify-center mt-0 w-10 h-10 rounded-full bg-transparent focus:outline-none hidden lg:flex"
          aria-expanded={isOpen}
          aria-haspopup="true"
        >
          <Globe className="h-7 w-10 text-dark ml-3" />
      ...
      <div className="flex lg:hidden">
        ...
        >
          ...
          <span className="text-dark dark:text-white">PT</span>
        </Button>
        <Button
          className="bg-white dark:bg-transparent"
          onClick={() => switchLanguage("en")}
        >
          ...
          <span className="text-dark dark:text-white">EN</span>
        </Button>
      </div>
    </>
  );
